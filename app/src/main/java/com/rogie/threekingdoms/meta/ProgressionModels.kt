...
data class Character(
    ...
    val maxHp: Int get() = maxHearts * 20
}
    ...
    fun get(characterId: CharacterId): Character {
        return when (characterId) {
            CharacterId.GUAN_YU -> Character(
                ...
                passiveDescription = "High base crit and strong offense.",
                maxHearts = 7,
                attack = 14,
                defense = 6,
                energy = 3,
            ...
            CharacterId.ZHUGE_LIANG -> Character(
                ...
                passiveDescription = "Draws extra cards and boosts strategy effects.",
                maxHearts = 6,
                attack = 9,
                defense = 7,
                energy = 3,
            ...
            CharacterId.CAO_CAO -> Character(
                ...
                passiveDescription = "Lifesteal and control-focused.",
                maxHearts = 7,
                attack = 11,
                defense = 8,
                energy = 3,
            ...
            CharacterId.ZHOU_YU -> Character(
                ...
                passiveDescription = "Burn and fire damage specialist.",
                maxHearts = 6,
                attack = 10,
                defense = 6,
                energy = 3,
            ...
            CharacterId.LU_BU -> Character(
                ...
                passiveDescription = "Extreme damage, high risk.",
                maxHearts = 5,
                attack = 16,
                defense = 4,
                energy = 3,
    ...
    fun treeFor(characterId: CharacterId): TalentTree {
        val nodes = when (characterId) {
            CharacterId.GUAN_YU -> listOf(
                ...
                TalentNode("gy_def_2", "Battle Focus", TalentPath.DEFENSE, "Start battle with 6 block.", 2, 6.0, listOf("gy_def_1")),
            ...
            CharacterId.ZHUGE_LIANG -> listOf(
                ...
                TalentNode("zl_def_2", "Woven Defense", TalentPath.DEFENSE, "Start with 8 block.", 2, 8.0, listOf("zl_def_1")),
            ...
            CharacterId.CAO_CAO -> listOf(
                ...
                TalentNode("cc_def_2", "Dark Resilience", TalentPath.DEFENSE, "Lifesteal heals +3.", 3, 3.0, listOf("cc_def_1")),
            ...
            CharacterId.ZHOU_YU -> listOf(
                ...
                TalentNode("zy_off_2", "Sea of Fire", TalentPath.OFFENSE, "Burn stacks +2.", 3, 2.0, listOf("zy_off_1")),
                ...
                TalentNode("zy_def_2", "Wave Guard", TalentPath.DEFENSE, "Start with 8 block.", 2, 8.0, listOf("zy_def_1")),
            ...
            CharacterId.LU_BU -> listOf(
                ...
                TalentNode("lb_def_3", "Reckless Guard", TalentPath.DEFENSE, "Gain 6 block when dropping below 50% HP.", 3, 6.0, listOf("lb_def_2")),
